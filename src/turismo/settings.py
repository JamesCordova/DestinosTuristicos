...
SECRET_KEY = 'django-insecure-(z)9j0f74y+zf@(@6kce2-hksu@bi^9cbh@netel-+a)gbe^+n'
...
STATIC_URL = 'static/'
# necesario para utilizar los archivos static
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static/')
]
STATIC_ROOT = os.path.join(BASE_DIR, 'assets')

# Otro cambio más para los archivos imagenes, videos, etc
MEDIA_URL = '/media/'
